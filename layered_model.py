...
def define_dense_model_single_layer(input_length, activation_f='sigmoid', output_length=1):
    ...
    model = Sequential()
    model.add(Dense(output_length, input_dim=input_length, activation=activation_f))
    return model
...
def define_dense_model_with_hidden_layer(input_length, 
    ...
    model = Sequential()
    model.add(Dense(hidden_layer_size, input_dim=input_length, activation=activation_func_array[0]))
